...
<body>
    ...
    <p class="sub">Completa los datos del curso y guarda los cambios (persistido en H2).</p>
    ...
    <div class="card">
        <form action="${ctx}${formAction}" method="post">
            ...
            <div class="actions">
                ...
                <a href="${ctx}/cursos-jdbc/lista.do" class="btn btn-gray">Cancelar</a>
            </div>
    ...
    <p style="margin-top: 20px;">
        <a href="${ctx}/cursos-jdbc/lista.do" style="color:#2c5f8a;">&larr; Volver a la lista</a>
    </p>
